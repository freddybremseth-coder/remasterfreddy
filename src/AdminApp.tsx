...
import { ArrowLeft, BarChart3, BrainCircuit, ExternalLink, Film, Image, ListChecks, Loader2, LockKeyhole, LogOut, Music2, ShieldCheck, Waves } from "lucide-react";
...
const tabs: Array<{ id: AdminTab; label: string; description: string; icon: typeof Music2 }> = [
  ...
  { id: "mixes", label: "Mix Studio", description: "3–30 min · musikk + visuals", icon: Waves },
  { id: "reels", label: "Reels Studio", description: "Instagram/Facebook · 9:16", icon: Film },
    ...
    <main className="admin-shell">
      ...
      <section className="admin-content">
        <div className="admin-intro">
          ...
          <p>Publisering, korte mixer, Reels, visuelle ressurser, kanalresultater og godkjente veksttiltak samlet under Re-Master Freddy.</p>
        </div>
