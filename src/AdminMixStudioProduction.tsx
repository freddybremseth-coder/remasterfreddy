  ...
  async function startProduction() {
    ...
    try {
      ...
      if (draft.targetMinutes < 3 || draft.targetMinutes > 30) {
        throw new Error("Velg en videolengde mellom 3 og 30 minutter og lagre utkastet først.");
      }
    ...
    <>
      ...
      <section className="admin-card admin-mix-studio">
        ...
        <div className="mix-production-footer">
          <div>
            <strong>Produksjonslengde: 3–30 minutter</strong>
            <span>Kortere mixer bruker samme kvalitet og visuelle regler, men er raskere og mer robuste å produsere.</span>
          </div>
