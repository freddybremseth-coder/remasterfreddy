...
function recommendedTrackCount(targetMinutes: number) {
  ...
  return Math.max(1, Math.min(60, Math.ceil(targetMinutes / 4)));
}
      ...
      <div className="mix-hero">
        <div>
          ...
          <p>
            ...
            Tilfeldig bildevalg skjer bare innenfor bildetyper og titler du tillater. Velg en kort miks fra 3 til 30 minutter; kortformat er standard for raskere og mer stabil produksjon.
          </p>
        </div>
      ...
      <div className="mix-section">
        <div className="mix-section-heading">
          <div>
            ...
            <p>Prompten følger valgt sound og kan brukes til korte eller lengre sammenhengende mixer.</p>
          </div>
